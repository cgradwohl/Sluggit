...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_native_auth_service__ = __webpack_require__(14);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_native_reg_validate_service__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_native_auth_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__native_auth_service__ = __webpack_require__(14);
...
module.exports = "<h4>\n  Popular: most liked posts\n\n  <table class=\"table table-striped table-hover \">\n  <thead>\n    <tr>\n      <th>Votes # (not yet implemented)</th>\n      <th>Title</th>\n      <th>Username</th>\n      <th>timestamp</th>\n    </tr>\n  </thead>\n  <tbody>\n    <tr>\n      <td>1</td>\n      <td>(show post title followed by link to the actual post)</td>\n      <td>(show creater's user name)</td>\n      <td>(show when it was posted)</td>\n    </tr>\n    <tr>\n      <td>2</td>\n      <td>Column content</td>\n      <td>Column content</td>\n      <td>Column content</td>\n    </tr>\n    <tr class=\"info\">\n      <td>3</td>\n      <td>Column content</td>\n      <td>Column content</td>\n      <td>Column content</td>\n    </tr>\n    <tr class=\"success\">\n      <td>4</td>\n      <td>Column content</td>\n      <td>Column content</td>\n      <td>Column content</td>\n    </tr>\n    <tr class=\"danger\">\n      <td>5</td>\n      <td>Column content</td>\n      <td>Column content</td>\n      <td>Column content</td>\n    </tr>\n    <tr class=\"warning\">\n      <td>6</td>\n      <td>Column content</td>\n      <td>Column content</td>\n      <td>Column content</td>\n    </tr>\n    <tr class=\"active\">\n      <td>7</td>\n      <td>Column content</td>\n      <td>Column content</td>\n      <td>Column content</td>\n    </tr>\n  </tbody>\n</table>\n</h4>\n"
...
module.exports = "\n<h4>\n  Public feed: most recent posts\n  <i> here is what a sample post may look like:</i>\n</h4>\n\n<div class=\"jumbotron\">\n  <h2><i>sample title</i></h2>\n  <p><i> sample body Sed finibus imperdiet rhoncus. Morbi et tellus augue. Fusce finibus consequat tincidunt.\n    Cras tempus dui vel ligula porta fermentum. Duis eu porttitor ligula. Suspendisse auctor lectus eget luctus\n    dictum. Etiam ullamcorper nisi in enim gravida mollis. Quisque elementum lectus risus, ac venenatis sapien dictum\n    eu. Maecenas porttitor sodales suscipit. Nullam imperdiet finibus massa, ut finibus libero lacinia a.</i></p>\n  <i>submited by: sample username</i>\n  <i>At: sample timestamp</i>\n</div>\n\n<div class=\"jumbotron\">\n  <h2><i>sample title</i></h2>\n  <p><i> sample body Sed finibus imperdiet rhoncus. Morbi et tellus augue. Fusce finibus consequat tincidunt.\n    Cras tempus dui vel ligula porta fermentum. Duis eu porttitor ligula. Suspendisse auctor lectus eget luctus\n    dictum. Etiam ullamcorper nisi in enim gravida mollis. Quisque elementum lectus risus, ac venenatis sapien dictum\n    eu. Maecenas porttitor sodales suscipit. Nullam imperdiet finibus massa, ut finibus libero lacinia a.</i></p>\n  <i>submited by: sample username</i>\n  <i>At: sample timestamp</i>\n</div>\n\n<div class=\"jumbotron\">\n  <h2><i>sample title</i></h2>\n  <p><i> sample body Sed finibus imperdiet rhoncus. Morbi et tellus augue. Fusce finibus consequat tincidunt.\n    Cras tempus dui vel ligula porta fermentum. Duis eu porttitor ligula. Suspendisse auctor lectus eget luctus\n    dictum. Etiam ullamcorper nisi in enim gravida mollis. Quisque elementum lectus risus, ac venenatis sapien dictum\n    eu. Maecenas porttitor sodales suscipit. Nullam imperdiet finibus massa, ut finibus libero lacinia a.</i></p>\n  <i>submited by: sample username</i>\n  <i>At: sample timestamp</i>\n</div>\n\n<div class=\"jumbotron\">\n  <h2><i>sample title</i></h2>\n  <p><i> sample body Sed finibus imperdiet rhoncus. Morbi et tellus augue. Fusce finibus consequat tincidunt.\n    Cras tempus dui vel ligula porta fermentum. Duis eu porttitor ligula. Suspendisse auctor lectus eget luctus\n    dictum. Etiam ullamcorper nisi in enim gravida mollis. Quisque elementum lectus risus, ac venenatis sapien dictum\n    eu. Maecenas porttitor sodales suscipit. Nullam imperdiet finibus massa, ut finibus libero lacinia a.</i></p>\n  <i>submited by: sample username</i>\n  <i>At: sample timestamp</i>\n</div>\n\n<div class=\"jumbotron\">\n  <h2><i>sample title</i></h2>\n  <p><i> sample body Sed finibus imperdiet rhoncus. Morbi et tellus augue. Fusce finibus consequat tincidunt.\n    Cras tempus dui vel ligula porta fermentum. Duis eu porttitor ligula. Suspendisse auctor lectus eget luctus\n    dictum. Etiam ullamcorper nisi in enim gravida mollis. Quisque elementum lectus risus, ac venenatis sapien dictum\n    eu. Maecenas porttitor sodales suscipit. Nullam imperdiet finibus massa, ut finibus libero lacinia a.</i></p>\n  <i>submited by: sample username</i>\n  <i>At: sample timestamp</i>\n</div>\n\n<div class=\"jumbotron\">\n  <h2><i>sample title</i></h2>\n  <p><i> sample body Sed finibus imperdiet rhoncus. Morbi et tellus augue. Fusce finibus consequat tincidunt.\n    Cras tempus dui vel ligula porta fermentum. Duis eu porttitor ligula. Suspendisse auctor lectus eget luctus\n    dictum. Etiam ullamcorper nisi in enim gravida mollis. Quisque elementum lectus risus, ac venenatis sapien dictum\n    eu. Maecenas porttitor sodales suscipit. Nullam imperdiet finibus massa, ut finibus libero lacinia a.</i></p>\n  <i>submited by: sample username</i>\n  <i>At: sample timestamp</i>\n</div>\n\n<div class=\"jumbotron\">\n  <h2><i>sample title</i></h2>\n  <p><i> sample body Sed finibus imperdiet rhoncus. Morbi et tellus augue. Fusce finibus consequat tincidunt.\n    Cras tempus dui vel ligula porta fermentum. Duis eu porttitor ligula. Suspendisse auctor lectus eget luctus\n    dictum. Etiam ullamcorper nisi in enim gravida mollis. Quisque elementum lectus risus, ac venenatis sapien dictum\n    eu. Maecenas porttitor sodales suscipit. Nullam imperdiet finibus massa, ut finibus libero lacinia a.</i></p>\n  <i>submited by: sample username</i>\n  <i>At: sample timestamp</i>\n</div>\n\n<div class=\"jumbotron\">\n  <h2><i>sample title</i></h2>\n  <p><i> sample body Sed finibus imperdiet rhoncus. Morbi et tellus augue. Fusce finibus consequat tincidunt.\n    Cras tempus dui vel ligula porta fermentum. Duis eu porttitor ligula. Suspendisse auctor lectus eget luctus\n    dictum. Etiam ullamcorper nisi in enim gravida mollis. Quisque elementum lectus risus, ac venenatis sapien dictum\n    eu. Maecenas porttitor sodales suscipit. Nullam imperdiet finibus massa, ut finibus libero lacinia a.</i></p>\n  <i>submited by: sample username</i>\n  <i>At: sample timestamp</i>\n</div>\n\n<div class=\"jumbotron\">\n  <h2><i>sample title</i></h2>\n  <p><i> sample body Sed finibus imperdiet rhoncus. Morbi et tellus augue. Fusce finibus consequat tincidunt.\n    Cras tempus dui vel ligula porta fermentum. Duis eu porttitor ligula. Suspendisse auctor lectus eget luctus\n    dictum. Etiam ullamcorper nisi in enim gravida mollis. Quisque elementum lectus risus, ac venenatis sapien dictum\n    eu. Maecenas porttitor sodales suscipit. Nullam imperdiet finibus massa, ut finibus libero lacinia a.</i></p>\n  <i>submited by: sample username</i>\n  <i>At: sample timestamp</i>\n</div>\n\n<div class=\"jumbotron\">\n  <h2><i>sample title</i></h2>\n  <p><i> sample body Sed finibus imperdiet rhoncus. Morbi et tellus augue. Fusce finibus consequat tincidunt.\n    Cras tempus dui vel ligula porta fermentum. Duis eu porttitor ligula. Suspendisse auctor lectus eget luctus\n    dictum. Etiam ullamcorper nisi in enim gravida mollis. Quisque elementum lectus risus, ac venenatis sapien dictum\n    eu. Maecenas porttitor sodales suscipit. Nullam imperdiet finibus massa, ut finibus libero lacinia a.</i></p>\n  <i>submited by: sample username</i>\n  <i>At: sample timestamp</i>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_rxjs_add_operator_map__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NativePostService; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NativePostService = (function () {
    // constructor()
    // injects the Http object
    function NativePostService(http) {
        this.http = http;
    }
    // addPost()
    // makes a POST request to the /register api endpoint
    ...
    // the map() method makes the post request an Observable
    NativePostService.prototype.addPost = function (post) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        // NOTE FOR LOCAL DEV comment out for heroku deployment
        var postObservable = this.http.post('http://localhost:3000/posts/add', post, { headers: headers }).map(function (res) { return res.json(); });
        // NOTE FOR HEROKU comment out for local development
        // const postObservable = this.http.post('posts/add', post, {headers: headers}).map(res => res.json());
        return postObservable;
    };
    NativePostService.prototype.getPost = function () {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        headers.append('Content-Type', 'application/json');
        // NOTE FOR LOCAL DEV comment out for heroku deployment
        var postObservable = this.http.get('http://localhost:3000/posts/add', { headers: headers }).map(function (res) { return res.json(); });
        // NOTE FOR HEROKU comment out for local development
        // const postObservable = this.http.post('posts/add', post, {headers: headers}).map(res => res.json());
    };
    return NativePostService;
}());
NativePostService = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["Http"]) === "function" && _a || Object])
], NativePostService);

var _a;
//# sourceMappingURL=native-post.service.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_public_feed_public_feed_component__ = __webpack_require__(104);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_profile_profile_component__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_popular_popular_component__ = __webpack_require__(102);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__components_search_search_component__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_add_post_add_post_component__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_native_reg_validate_service__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__services_native_auth_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__services_guards_native_auth_guard_service__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__services_native_post_service__ = __webpack_require__(65);
...
var appRoutes = [
    ...
    { path: 'feed', component: __WEBPACK_IMPORTED_MODULE_11__components_public_feed_public_feed_component__["a" /* PublicFeedComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_18__services_guards_native_auth_guard_service__["a" /* NativeAuthGuardService */]] },
    { path: 'profile', component: __WEBPACK_IMPORTED_MODULE_12__components_profile_profile_component__["a" /* ProfileComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_18__services_guards_native_auth_guard_service__["a" /* NativeAuthGuardService */]] },
    { path: 'popular', component: __WEBPACK_IMPORTED_MODULE_13__components_popular_popular_component__["a" /* PopularComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_18__services_guards_native_auth_guard_service__["a" /* NativeAuthGuardService */]] },
    { path: 'search', component: __WEBPACK_IMPORTED_MODULE_14__components_search_search_component__["a" /* SearchComponent */] },
    { path: 'add-post', component: __WEBPACK_IMPORTED_MODULE_15__components_add_post_add_post_component__["a" /* AddPostComponent */] }
];
// NG MODULE CONFIG
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [
            __WEBPACK_IMPORTED_MODULE_16__services_native_reg_validate_service__["a" /* NativeRegisterValidationService */],
            __WEBPACK_IMPORTED_MODULE_17__services_native_auth_service__["a" /* NativeAuthService */],
            __WEBPACK_IMPORTED_MODULE_18__services_guards_native_auth_guard_service__["a" /* NativeAuthGuardService */],
            __WEBPACK_IMPORTED_MODULE_19__services_native_post_service__["a" /* NativePostService */]
        ],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_native_post_service__ = __webpack_require__(65);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__);
...
var AddPostComponent = (function () {
    function AddPostComponent(nativePostService, router, flashMessage) {
        this.nativePostService = nativePostService;
        this.router = router;
        this.flashMessage = flashMessage;
    }
    ...
    AddPostComponent.prototype.onNativeAddPost = function () {
        var _this = this;
        var post = {
            title: this.title,
            description: this.description
        };
        this.nativePostService.addPost(post).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('Post successful!', { cssClass: 'alert-success' });
                _this.router.navigate(['/feed']);
            }
            else {
                _this.flashMessage.show(data.msg, { cssClass: 'alert-danger' });
...
AddPostComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_native_post_service__["a" /* NativePostService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_native_post_service__["a" /* NativePostService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"]) === "function" && _c || Object])
], AddPostComponent);
